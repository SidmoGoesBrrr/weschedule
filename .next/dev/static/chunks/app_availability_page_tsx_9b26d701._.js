...
"[project]/app/availability/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
_c = Button;
const GhostButton = ({ children, className = "", ...props })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
...
function GroupHeatmap({ records }) {
    ...
    const heatmap = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "GroupHeatmap.useMemo[heatmap]": ()=>buildHeatmap(records)
    }["GroupHeatmap.useMemo[heatmap]"], [
        records
    ]);
    const maxCount = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "GroupHeatmap.useMemo[maxCount]": ()=>{
            let max = 0;
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    SLOTS.map((slot)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            style: {
                                                height: 20
                                            },
...
_s(GroupHeatmap, "Edqw7SfKoWgSEylOmkPCS+bF9x0=");
_c4 = GroupHeatmap;
// --- Name entry screen ---
...
_s1(NameEntry, "gFPpQ6rgfiGkmgRsh4q2nIO1W+Q=");
_c5 = NameEntry;
// --- Availability form ---
function AvailabilityForm({ userId, onChangeName }) {
    _s2();
    const [availability, setAvailability] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(makeDefaultAvailability());
    ...
    const errors = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AvailabilityForm.useMemo[errors]": ()=>{
            const next = {};
            for (const day of DAYS){
                ...
                const dayErrors = [];
                d.blocks.forEach({
                    "AvailabilityForm.useMemo[errors]": (b, i)=>{
                        const s = minutesFromHHMM(b.start);
                        const e = minutesFromHHMM(b.end);
                ...
                const sorted = [
                    ...
                    "AvailabilityForm.useMemo[errors].sorted": (b)=>({
                            ...b,
                            s: minutesFromHHMM(b.start),
                            e: minutesFromHHMM(b.end)
                        })
                }["AvailabilityForm.useMemo[errors].sorted"]).filter({
                    "AvailabilityForm.useMemo[errors].sorted": (x)=>Number.isFinite(x.s) && Number.isFinite(x.e)
                }["AvailabilityForm.useMemo[errors].sorted"]).sort({
                    "AvailabilityForm.useMemo[errors].sorted": (a, b)=>a.s - b.s
                }["AvailabilityForm.useMemo[errors].sorted"]);
    ...
    const peopleCounts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AvailabilityForm.useMemo[peopleCounts]": ()=>{
            const heatmap = buildHeatmap(allRecords);
            return Object.fromEntries(DAYS.map({
                "AvailabilityForm.useMemo[peopleCounts]": (day)=>{
                            ...
                            children: [
                                    ...
                                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    d.blocks.map((b, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            dayErrors.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                                                className: "mt-3 list-disc pl-6 text-sm text-red-600",
                                                children: dayErrors.map((msg, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                                        children: msg
                                                    }, i, false, {
                                                        fileName: "[project]/app/availability/page.tsx",
                                                        lineNumber: 613,
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        hasErrors && !isSaving && !isLoading && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(Card, {
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(CardContent, {
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(GroupHeatmap, {
                            records: allRecords
                        }, void 0, false, {
                            fileName: "[project]/app/availability/page.tsx",
                            lineNumber: 637,
...
_s2(AvailabilityForm, "dqMeWjQ80kqororOf2s+hQDZ0tQ=");
_c6 = AvailabilityForm;
function AvailabilityPage() {
    ...
    if (!userId) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(NameEntry, {
        onSet: setUserId
    }, void 0, false, {
        fileName: "[project]/app/availability/page.tsx",
        lineNumber: 658,
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(AvailabilityForm, {
        userId: userId,
        onChangeName: ()=>{
...
_s3(AvailabilityPage, "3MAAEDr4aQJhrw1zQzit8BZDE4I=");
_c7 = AvailabilityPage;
...
__turbopack_context__.k.register(_c4, "GroupHeatmap");
__turbopack_context__.k.register(_c5, "NameEntry");
__turbopack_context__.k.register(_c6, "AvailabilityForm");
__turbopack_context__.k.register(_c7, "AvailabilityPage");
...
//# sourceMappingURL=app_availability_page_tsx_9b26d701._.js.map