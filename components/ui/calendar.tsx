  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: "border-2 border-border rounded-base cursor-pointer transition-all duration-150 hover:bg-main/20 hover:border-black hover:scale-105",
        button_next: "border-2 border-border rounded-base cursor-pointer transition-all duration-150 hover:bg-main/20 hover:border-black hover:scale-105",
